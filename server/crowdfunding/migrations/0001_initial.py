    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='no-image',
                 upload_to=crowdfunding.models.get_Funding_Image)),
                ('is_closed', models.BooleanField(default=False)),
                ('is_verified', models.BooleanField(default=False)),
                ('ngo_certficate', models.ImageField(default='no-image',
                 upload_to=crowdfunding.models.get_ngo_certificate)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='crowdfunding.funding')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donation_message', models.CharField(
                    blank=True, max_length=1000, null=True)),
                ('donar_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('funding_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='crowdfunding.funding')),
            ],
